        ...
        <main className="grow">
            <section className="bg-box block grid-cols-2 md:grid gap-4 px-4 py-10 text-white">
                <div className="my-auto">
                    ...
                    <div className="flex">
                        <button className="bg-white text-black font-semibold px-6 py-2 hover:opacity-75 mt-8 md:mt-4 lg:mt-8 rounded-md me-3"><Link to={"/booking"}>Book Now</Link></button>
                        <button className="bg-accent text-white font-semibold px-6 py-2 hover:opacity-75 mt-8 md:mt-4 lg:mt-8 rounded-md me-3"><Link to={"/services"}>Our Services</Link></button>
                    </div>
                </div>
            ...
            <section className="px-4 py-10">
                ...
                <button className="mt-12 bg-accent px-4 py-3 rounded-md mx-auto hover:opacity-75 font-semibold text-white block"><Link to={"/services"}>View All Services <FontAwesomeIcon icon={faArrowRight} /></Link></button>
            </section>
            ...
            <section className="px-4 py-10">
                ...
                <ClusterMap />
                <button className="mt-12 bg-accent px-4 py-3 rounded-md mx-auto hover:opacity-75 font-semibold text-white block"><Link to={"/contact"}>View All Branches <FontAwesomeIcon icon={faArrowRight} /></Link></button>
            </section>
        </main>
    )
}
